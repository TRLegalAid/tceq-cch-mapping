# This script loads the 2020 census legacy files released August 16, 2021
# This script and the data files in the input/tx2020.pl folder were obtained here on 8/27/21:
...
# -----------------------------
header_file_path <- "input/tx2020.pl/txgeo2020.pl"
part1_file_path  <- "input/tx2020.pl/tx000012020.pl"
part2_file_path  <- "input/tx2020.pl/tx000022020.pl"
part3_file_path  <- "input/tx2020.pl/tx000032020.pl"
...
write.csv(combine, "interim/census_tx_2020.csv")
